	...
	if (songData) {
		...
		mainLoop = setInterval(function(){	// Check every 25 ms
			...
			songLength += noteLength			
				...
				if (songNum == 56) gainNode.gain.value = volume		// No attack envelope on "What Lightning Flash" due to trills
				else {
